...
<p><label for="lpap_show_gravatar">Show Gravatar?
	<select id="lpap_show_gravatar"	name="lpap_show_gravatar">
		<option <?php selected( 0, $this->options[ 'show_gravatar' ] ); ?> value="0"><?php _e( 'No' ); ?></option>
		<option <?php selected( 1, $this->options[ 'show_gravatar' ] ); ?> value="1"><?php _e( 'Yes' ); ?></option>
	</select> </label></p>
<p><label for="lpap_gravatar_size">Gravatar size: 
	<input class="narrowfat" type="text" name="lpap_gravatar_size" id="lpap_gravatar_size" value="<?php echo attribute_escape( $this->options[ 'gravatar_size' ] ); ?>" /> </label>
	<br />E.g. 16 (for 16 pixels). Just enter the number
</p>
